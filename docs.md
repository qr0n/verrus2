...
slash = SlashCommand(bot, sync_commands=True) } = declaring command handlers and commands
...
bot.sniped_messages = {}
{bot.author_id = 578789460141932555} = the person who wrote the bot
{web = os.environ.get("webhook")
web2 = os.environ.get("webhook2")
web3 = os.environ.get("webhook3")
web4 = os.environ.get("webhook4")} = webhook definitions
...
{extensions = [
    ...
    'cogs.write_cog',
    #'cogs.entir'
]} = extentions that the bot loads at startup
